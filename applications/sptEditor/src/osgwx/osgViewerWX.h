...
class Preview3DFrame : public wxFrame
{
public:
//	Preview3DFrame(wxFrame *frame, const wxString& title, const wxPoint& pos,
//        const wxSize& size, long style = wxDEFAULT_FRAME_STYLE);
	Preview3DFrame(wxFrame *frame, std::string title, boost::python::tuple pos,
        boost::python::tuple size, long style = wxDEFAULT_FRAME_STYLE);
